...
public class InstructorSignUp extends AppCompatActivity implements View.OnClickListener {
    ...
    private void registerUser() {
        ...
        final String email = IDNumber.getText().toString().trim() + "@kfupm.edu.sa";
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(InstructorSignUp.this, "Registered successfully", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(InstructorSignUp.this, "ERROR! failed to register", Toast.LENGTH_LONG).show();
                            progressDialog.hide();
                        }
                    }
