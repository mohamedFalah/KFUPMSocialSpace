...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = FabUtil.dpToPx(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = FabUtil.dpToPx(getContext(), 0f);
    private int mLabelsVerticalOffset = FabUtil.dpToPx(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = FabUtil.dpToPx(getContext(), 4f);
    private int mLabelsPaddingRight = FabUtil.dpToPx(getContext(), 8f);
    private int mLabelsPaddingBottom = FabUtil.dpToPx(getContext(), 4f);
    private int mLabelsPaddingLeft = FabUtil.dpToPx(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = FabUtil.dpToPx(getContext(), 3f);
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = FabUtil.dpToPx(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = FabUtil.dpToPx(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = FabUtil.dpToPx(getContext(), mMenuShadowYOffset);
        }
